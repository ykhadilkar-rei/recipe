package net.khadilkar.recipe.bootstrap;

import net.khadilkar.recipe.domain.*;
import net.khadilkar.recipe.repositories.CategoryRepository;
import net.khadilkar.recipe.repositories.RecipeRepository;
import net.khadilkar.recipe.repositories.UnitOfMeasureRepository;
